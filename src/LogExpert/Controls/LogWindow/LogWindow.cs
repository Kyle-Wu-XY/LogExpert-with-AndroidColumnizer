...
namespace LogExpert
{
    public partial class LogWindow : DockContent, ILogPaintContext, ILogView
    {
        ...
        private readonly List<HighlightColor> _tempHighlightColorList = new List<HighlightColor>{
             ...
             new HighlightColor(Color.FromArgb(0xFF, 0xAC, 0xFF, 0xA1),Color.FromArgb(0xFF, 0x0F, 0x80, 0x00)),
             new HighlightColor(Color.FromArgb(0xFF, 0xFF, 0xE8, 0xA1),Color.FromArgb(0xFF, 0x80, 0x60, 0x00)),
             new HighlightColor(Color.FromArgb(0xFF, 0xD2, 0xA1, 0xFF),Color.FromArgb(0xFF, 0x42, 0x00, 0x80)),
             new HighlightColor(Color.FromArgb(0xFF, 0xA1, 0xFE, 0xFF),Color.FromArgb(0xFF, 0x00, 0x7F, 0x80)),
             new HighlightColor(Color.FromArgb(0xFF, 0xA1, 0xDB, 0xFF),Color.FromArgb(0xFF, 0x00, 0x4E, 0x80)),
             new HighlightColor(Color.FromArgb(0xFF, 0xA2, 0x9C, 0xCF),Color.FromArgb(0xFF, 0x12, 0x00, 0x80)),
             new HighlightColor(Color.FromArgb(0xFF, 0xF5, 0xA1, 0xFF),Color.FromArgb(0xFF, 0x72, 0x00, 0x80)),
             new HighlightColor(Color.FromArgb(0xFF, 0xFF, 0xC4, 0xA1),Color.FromArgb(0xFF, 0x80, 0x30, 0x00)),
             new HighlightColor(Color.FromArgb(0xFF, 0xD0, 0xFF, 0xA1),Color.FromArgb(0xFF, 0x3F, 0x80, 0x00)),
             new HighlightColor(Color.FromArgb(0xFF, 0xF3, 0xFF, 0xA1),Color.FromArgb(0xFF, 0x6F, 0x80, 0x00)),
             new HighlightColor(Color.FromArgb(0xFF, 0xE3, 0xE3, 0xD2),Color.FromArgb(0xFF, 0x99, 0x99, 0x99)),
             new HighlightColor(Color.FromArgb(0xFF, 0xD3, 0xD3, 0xC3),Color.FromArgb(0xFF, 0x66, 0x66, 0x66)),
             new HighlightColor(Color.FromArgb(0xFF, 0xA3, 0xA3, 0x96),Color.FromArgb(0xFF, 0x22, 0x22, 0x22)),
             new HighlightColor(Color.FromArgb(0xFF, 0x53, 0x53, 0x4C),Color.FromArgb(0xFF, 0xDD, 0xDD, 0xDD)),
             new HighlightColor(Color.FromArgb(0xFF, 0x13, 0x13, 0x11),Color.FromArgb(0xFF, 0xAA, 0xAA, 0xAA)),
             new HighlightColor(Color.FromArgb(0xFF, 0x00, 0x00, 0xFF),Color.FromArgb(0xFF, 0xF0, 0xF0, 0xFF)),
             new HighlightColor(Color.FromArgb(0xFF, 0xFF, 0x00, 0x00),Color.FromArgb(0xFF, 0xFF, 0xFF, 0xFF)),
             new HighlightColor(Color.FromArgb(0xFF, 0x00, 0xFF, 0x00),Color.FromArgb(0xFF, 0x35, 0x5F, 0x35)),
             new HighlightColor(Color.FromArgb(0xFF, 0xFF, 0xFF, 0x00),Color.FromArgb(0xFF, 0x6F, 0x6F, 0x4C))
        }; 
